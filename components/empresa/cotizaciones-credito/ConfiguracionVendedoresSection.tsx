...
const styles = {
  ...
  switchTrackSmall: "relative inline-flex items-center h-5 w-9 shrink-0 cursor-pointer rounded-full p-0.5 transition-colors duration-200 ease-in-out focus:outline-none disabled:opacity-50",
  switchThumbSmall: "pointer-events-none block h-4 w-4 transform rounded-full bg-slate-950 shadow ring-0 transition duration-200 ease-in-out",
};
    ...
    <section className="space-y-6 pt-4 border-t border-slate-800/80">
      <div className="space-y-1">
        ...
        <p className="text-xs text-slate-400">
          Si un vendedor tiene una regla, sobrescribe a la configuración por equipo, por zona y general.
        </p>
      </div>
