...
interface StockVentaModalProps {
  showSellerModal: boolean;
  mounted: boolean;
  vendedorSeleccionado: string;
  setVendedorSeleccionado: (id: string) => void;
  vendedoresList: Vendedor[];
  error: string | null;
  setError: (err: string | null) => void;
  handleCancelVenta: () => void;
  handleConfirmVenta: () => void;
}

export function StockVentaModal({
  showSellerModal,
  mounted,
  ...
  handleCancelVenta,
  handleConfirmVenta,
}: StockVentaModalProps) {
  if (!showSellerModal || !mounted) return null;
